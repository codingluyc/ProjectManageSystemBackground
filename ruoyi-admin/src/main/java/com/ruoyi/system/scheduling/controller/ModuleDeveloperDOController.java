...
import com.ruoyi.system.scheduling.service.IModuleDeveloperDOService;
 ...
 */
@RestController
@RequestMapping("/scheduling/moduleDeveloper")
public class ModuleDeveloperDOController extends BaseController
{
     ...
     * 查询模块开发者列表
     */
    @PreAuthorize("@ss.hasPermi('scheduling:moduleDeveloper:list')")
    @GetMapping("/list")
     ...
     * 导出模块开发者列表
     */
    @PreAuthorize("@ss.hasPermi('scheduling:moduleDeveloper:export')")
     ...
     * 获取模块开发者详细信息
     */
    @PreAuthorize("@ss.hasPermi('scheduling:moduleDeveloper:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增模块开发者
     */
    @PreAuthorize("@ss.hasPermi('scheduling:moduleDeveloper:add')")
     ...
     * 修改模块开发者
     */
    @PreAuthorize("@ss.hasPermi('scheduling:moduleDeveloper:edit')")
     ...
     * 删除模块开发者
     */
    @PreAuthorize("@ss.hasPermi('scheduling:moduleDeveloper:remove')")
