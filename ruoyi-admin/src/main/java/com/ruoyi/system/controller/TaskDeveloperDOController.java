...
import com.ruoyi.system.service.ITaskDeveloperDOService;
 ...
 */
@RestController
@RequestMapping("/systemManage/taskDeveloper")
public class TaskDeveloperDOController extends BaseController
{
     ...
     * 查询任务-开发者列表
     */
    @PreAuthorize("@ss.hasPermi('systemManage:taskDeveloper:list')")
    @GetMapping("/list")
     ...
     * 获取任务-开发者详细信息
     */
    @PreAuthorize("@ss.hasPermi('systemManage:taskDeveloper:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增任务-开发者
     */
    @PreAuthorize("@ss.hasPermi('systemManage:taskDeveloper:add')")
     ...
     * 修改任务-开发者
     */
    @PreAuthorize("@ss.hasPermi('systemManage:taskDeveloper:edit')")
     ...
     * 删除任务-开发者
     */
    @PreAuthorize("@ss.hasPermi('systemManage:taskDeveloper:remove')")
